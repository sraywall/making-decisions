...
/*
  ...
  one should wear a rain-jacket. If it is 60 degrees or below, one should wear a jacket and carry an umbrella. 
...
if(temperature >= 80 && rain === true){
  ...
  console.log("Wear a coat and carry an umbrella")
} else {
...
console.log(changeMyMind)
// if(changeMyMind === false || changeMyMind == true){
//   changeMyMind = !changeMyMind
//   console.log(changeMyMind)
// }
////////// ADVANCED PROBLEMS //////////
